export const longStrings = {
  PublicCharDesc:
    "To protect security and user rights, we update hoyolab role data through the user's device (client) rather than through the server. This means that if a user does not use Stargazer for a while, it may result in discrepancies in their character count, days active, achievements achieved, and the Forgotten Hall data. Please note that these data are for reference only and are not accurate.",
  TrailblazerNotiTaggedU:
    'Player ${1} in "${2}\'s Discussion" has mentioned you! Come to join the discussion.',
  ...
  LoginPolicy:
    ...
    GithubStarPlease: "If you think this project is helpful, please give us a star in GitHub, thx!",
